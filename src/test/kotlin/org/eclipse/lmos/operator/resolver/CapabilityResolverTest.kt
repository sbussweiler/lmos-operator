...
class CapabilityResolverTest {
    ...
    fun testFindHighestVersion() {
        ...
        val bestMatchingWire =
            Wire(
                RequiredCapability("capabilityId-1", "capability1", "1.0.0"),
                ProvidedCapability("capabilityId-1", "capability1", "1.3.0", "description"),
                AgentResource(),
            )
        ...
        wires.add(
            Wire(
                RequiredCapability("capabilityId-1", "capability1", ">=1.0.0"),
                ProvidedCapability("capabilityId-1", "capability1", "1.2.0", "description"),
                AgentResource(),
            ),
        )
        ...
        wires.add(
            Wire(
                RequiredCapability("capabilityId-1", "capability1", ">=1.0.0"),
                ProvidedCapability("capabilityId-1", "capability1", "1.1.0", "description"),
                AgentResource(),
            ),
        )
    ...
    fun testFindMostSimilarVersion() {
        ...
        val bestMatchingWire =
            Wire(
                RequiredCapability("capabilityId-1", "capability1", "1.0.0"),
                ProvidedCapability("capabilityId-1", "capability1", "1.0.1", "description"),
                AgentResource(),
            )
